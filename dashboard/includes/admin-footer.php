<?php
/**
 * Easy Car Luxury - Footer del Administrador
 * ARCHIVO ESTANDARIZADO PARA EL PANEL DE ADMINISTRACIÓN
 * 
 * Uso: include_once __DIR__ . '/../includes/admin-footer.php';
 */
...
<!-- SCRIPTS GLOBALES CON RUTAS LOCALES -->
...
<script>
    // Función para logout con confirmación (si se necesita)
